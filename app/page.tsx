      ...
      <HomepageMainBoard
        banner={
          <div>
            <img
              className={"w-[600px]"}
              src="https://raw.githubusercontent.com/canyon-project/canyon/main/screenshots/architecture.png"
              alt=""
            />
          </div>
        }
...
to automatically capture API calls as test cases.`,
                img: (
                  <img
                    src="/ui/img/workflows/img_02.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
...
as mocks for more reliable, affordable testing.`,
                img: (
                  <img
                    src="/ui/img/workflows/img_03.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
...
traffic desensitization to enhance your data security.`,
                ...
                img: (
                  <img
                    src="/ui/img/workflows/img_21.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
...
experience without the setup of test environment.`,
                img: (
                  <img
                    src="/ui/img/workflows/img_22.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
...
code bugs through response discrepancies.`,
                img: (
                  <img
                    src="/ui/img/workflows/img_11.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
...
like ( timestamps, random values) to ensure high quality tests.`,
                img: (
                  <img
                    src="/ui/img/workflows/img_12.png"
                    alt=""
                    className={"w-[480px]"}
                  />
                ),
